                          ...
                          <div class="css-ylrg3u">
                            <div class="css-4cffwv">
                              <div
                                ...
                                @click="MenuChoose(0)"
                              >
                                {{ $t("message.user.shiyongxindizhi") }}
                              </div>
                              <div
                                :class="
                                  m_menuchoose == 1
...
export default {
  ...
  methods: {
    ...
    getWithdraw_open() {
      Axios2.getWithdrawToken().then((res) => {
    ...
    formSubmit() {
      ...
      // 申请提现
      Axios2.withdrawApply(withdrawParams).then((res) => {
        var jsonArray = res;
        if (jsonArray.code == 0) {
...
@import url("@/assets/css/wallet/withdraw.css");
