export default {
  ...
  "h-s2-t1": "popular",
  "h-s2-t2": "Foreign Exchange",
  "h-s2-t3": "Digital cryptocurrency",
  "h-s2-t4": "index",
  "h-s2-t5": "Bulk commodities",
  "h-s2-t6": "Stock CFD",
  "h-s2-h1": "Tools",
  "h-s2-h2": "price",
  ...
  "h-s4-1-d1":
    "Enjoy spreads as low as 0.0 pips, strong liquidity and no requotes.",
  "h-s4-2-t1": "Extremely low spreads",
  "h-s4-2-d1":
    "Enjoy spreads as low as 0.0 pips, strong liquidity and no requotes.",
  "h-s4-3-t1": "Regulated Broker",
  "h-s4-3-d1":
    "We are fully regulated by the SCB. Client funds are segregated in first-tier banks.",
  "h-s4-4-t1": "Powerful trading platform",
  "h-s4-4-d1":
    "Access the world's most popular TradingView, MT4, MT5 or c Trader platforms on desktop, tablet and mobile.",
  "h-s5-t1": "Free trade",
  "h-s5-t2": "One account, multiple trading platforms.",
  "h-s5-1-t1": "TradingView",
  "h-s5-1-d1":
    "Access TradingView's advanced charting tools and interact with over 30 million traders using the latest integration powered by cTrader.",
  ...
  "h-s5-3-d1":
    "Faster processing times, newly released hedging position functionality, advanced pending orders, and the latest tools and indicators help you take your trading to the next level.",
  "h-s5-4-t1": "cTrader",
  "h-s5-4-d1":
    "An intuitive and easy-to-use platform with advanced ordering capabilities and customization capabilities.",
  "h-s5-t2": "Register now and start trading",
  "h-s5-d1": "View our privacy policy",
  "h-s6-t1": "Make your transactions even more powerful",
  "h-s6-d1": "Browse all articles",
  "h-s6-1-t1": "Foreign exchange market, unlimited opportunities",
  "h-s6-1-d1":
    "The foreign exchange market is an ideal vehicle for macroeconomic themes, especially the relative differences between two currencies.",
  "h-s6-1-b1": "FOREX",
  "h-s6-2-t1": "How will gold price return to the $2,000 mark?",
  "h-s6-2-d1":
    "We see 2023 as a reflection of 2022, and although it's still early, we clearly feel that financial conditions are slowing. The global economy is recovering and inflation has peaked. So, we see...",
  "h-s6-2-b1": "GOLD",
  "h-s6-3-t1": "Reversal! Plunge! What has changed in the inflation data",
  "h-s6-3-d1":
    "Everyone knew yesterday's inflation data was important, and it turned out to be a bombshell, destroying the recent optimistic market sentiment and triggering a series of sell-offs and revaluations of assets.",
  "h-s6-3-b1": "GOLD",
  ...
  "ready-t2": "Are you ready to trade?",
  "ready-d2":
  ...
  zhaodaogengduao: "find more",
  liaojiegengduao: "Learn more",
  jiaru: "Join now",
  ...
  "header-s-s1-a3": `<div class="rich-text__container"><h5>We get asked this question a lot. Part of the difficulty in answering this question is that ECN and STP are marketing terms taken from the listing market regime, and are given different meanings by different providers in the industry. </h5>
   ...
   <h5>For more information on this, please contact <a href="mailto:support@demo.com">support@demo.com</a>. </h5></div>`,
  ...
  "m1-LEI-s2-5-d1":
    "If you have any questions about obtaining an LEI, please contact support{'@'}demo.com",
  // m1-award
  ...
  "m1-at-s1-d3":
    "Your discount is based on how many standard lots you trade per month – the more you trade, the higher your commission discount. Unlike most programs, our Forex discounts are refunded the day after your daily position closes directly to Your trading account.",
  "m1-at-s1-d4":
  ...
  "m1-why-s5-d1": `We offer access to raw spreads so you know exactly what you’re getting charged from a liquidity provider and what we earn. Find out more about <a href="/#/trading/spreads-swaps-commissions">our"pricing</a>.`,
  ...
  "m1-why-s5-d5": `Free access to three major platforms. <a href="/#/trading-platforms/platforms/metatrader4">MT4</a>, <a href="/#/trading-platforms/platforms/metatrader5">MT5</a> and cTrader Available on your computer, mobile phone or tablet, or accessed through our web application. `,
  "m1-why-s5-d6":
  ...
  "m1-why-s5-d8": `Earn cash on high volume trades with our <a href="/#/why-demo/active-trader-program">Active"Trader program</a> rebate.`,
  "m1-why-s5-d9":
    "Earn 20 free trades ✝ for you and your friends when your friends open and fund trading accounts. Learn more.",
  ...
  "m1-why-s6-1-l1": `<a href="/#/contact-us">Contact us</a>`,
  ...
  "m2-product-4-s5-1-d2":
    "Leverage trading – only need to pay a certain percentage of the nominal dollar value of the capital, so that your capital can play a greater role.",
  ...
  "m2-product-5-s3-h1": "United States",
   ...
   "m2-product-5-s3-v1":
     "Find trading opportunities on over 600 US share CFDs from the NYSE and NASDAQ exchanges",
   "m2-product-5-s3-v2": "Explore our 100 UK stocks on the LSE",
   "m2-product-5-s3-v3": "Discover trading opportunities within our range of share CFDs from XETRA Germany",
   "m2-product-5-s3-v4": "Trade 200 Australian stocks from ASX",
   "m2-product-5-s3-v5": "Explore our 100+ ETF CFDs from 35 countries",
...
This extra trading session over the weekend not only means you have more time to speculate on the prices of different tokens, but any stops and take profits you have attached can be covered over the weekend. `,
  ...
  "m2-ac-s2-d3": `<h5>*Commissions may vary depending on your account, platform and base currency. Learn more about <a href="/#/trading/spreads-swaps-commissions" rel="noreferrer noopener" "target="_self">Spreads and commissions.</a></h5>`,
  "m2-ac-s2-h1": "",
  "m2-ac-s2-h2": "Razor",
  ...
  "m3-mt4-s3-1-d1": `<div class="rich-text__container"><ul><li><a href="#" target="_self">Android MT4</a></li></ul><h5> or through our <a href="#" rel="noreferrer noopener">web application</a> access MT4</h5></div>`,
  "m3-mt4-s3-2": "Desktop",
  "m3-mt4-s3-2-d1": `<div class="rich-text__container"><ul><li><a href="#" target="_self">Windows MT4</a></li></ul><h5>or through our <a href="#"  rel="noreferrer noopener">web application</a> access to MT4</h5><h5>operating system requirements</h5 ><ul><li>Vista, Windows 7, Windows 8/8.1 or Windows 10, at least 8MB RAM</li></ul></div>`,
  ...
  "m3-mt4-s7-a1": `<div class="rich-text__container"><h6>First, from your <a href="javascript:void(0)"  rel="noreferrer noopener">SCA client</a> downloads MT4. You'll be prompted to complete the download process, and once your platform has loaded, you'll be asked for your account number, password, and server name. </h6>
  <h6>If you have trouble entering these details, please try the following:</h6>
  <ol><li>Copy and paste the password (make sure you are not using any spaces)</li><li>Manually enter your server IP address</li><li>Backspace server and manually enter the server IP address'edge&lt ;Server ID&gt;.demo.com'. For example, Edge 03 = edge03.demo.com</li></ol>
  ...
  "m3-mt5-s6-t1": `<div class="rich-text__container"><h2 class="mb-8 fs-32">User Guides and Videos</h2><ul><li><a href="javascript:void(0)"  rel="noreferrer noopener">>How to download and install MT5</a></li><li><a href="javascript:void(0)"  rel="noreferrer noopener">MT5 platform walk-through</a></li></ul></div>`,
  ...
  "m3-st-t-s-s6-9-d1":
    "Similar to Bollinger® Bands, but channel width varies based on ATR.",
  ...
  "m4-mn-a5-c": `h5><strong>Focus this week</strong></h5>
   ...
   ="ugt5zn34s9wv"></b></h5>
   <h5>The international oil price continued its recent decline after falling below the support of the long-term trend line. Fundamentals still revolve around Russia’s (oil price ceiling) and imposed (export ban) sanctions, but the economic slowdown makes the medium and long-term trend of oil prices bearish, and a series of Chinese economic data this Friday is expected to have a significant impact. If WTI crude oil fails to break through $90, it may retest the level of $80 and lower. </h5>
  ...
  "m4-mn-a6-c": `<h5>How to balance the historically high inflation rate of 9.1% and the impending recession, how to make the 19 member states with different economic conditions feel about the path of interest rate hike and monetary policy Satisfied, how to solve the energy crisis and geopolitical conflicts that are not within the control? </h5>
   ...
   <h5>In addition, we need to pay attention to the situation of the balance sheet. While raising interest rates in advance, shrinking the balance sheet may not be the key topic of this meeting, or even this year, especially considering that Italy’s September election may further widen the interest rate differential between Italy and other European countries. The central bank may keep the market liquid for now. </h5>
  ...
  "m4-mn-a8-c": `<div class="rich-text__container"><h5>Because of the long weekend of the Labor Day holiday in the United States, the focus of the market at the beginning of this week is still on energy prices. European natural gas futures prices soared 30% at the opening on Monday and closed 12% higher throughout the day. This trend fully reflects the impact of Russia's indefinite suspension of gas supply from the Nord Stream 1 pipeline. </h5>
   ...
   "e8hm0f0x9ocf"></h5>
   <h5>The People’s Bank of China announced yesterday that it lowered the reserve requirement ratio for foreign exchange deposits to 6%. RMB pressure. But the dollar against the offshore yuan (USDCNH) is still further higher above 6.94. Today's central parity rate of USD/RMB broke through 6.9000. The depreciation pressure of RMB will also drag down the trend of commodity currencies such as Australia and New Zealand. </h5>
  ...
  "m4-mn-a9-t":
    "【This week's outlook】Russia cuts off gas and OPEC cuts production? The three major central banks take turns to debut this week!",
  "m4-mn-a9-d":
  ...
  "m4-mn-a9-c": `<div class="rich-text__container"><h3><strong>Focus this week</strong></h3>
   ...
   <h5>September 7 (Wednesday): Q2 GDP of Australia and the Eurozone, China’s August import and export data, Powell’s speech, Bank of Canada interest rate decision</h5>
   <h5>September 8 (Thursday): Japan’s second-quarter GDP, RBA Chairman’s Speech, European Central Bank’s interest rate decision, U.S. initial request</h5>
  ...
  "m4-mn-a12-d":
    "Among commodities, gold is known as the 'king of precious metals', and oil also has a very famous name—black gold.",
  ...
  "m4-mn-a12-c": `<div class="rich-text__container"><h5>"Black" refers to the color, and "gold" represents the huge value of oil reserves. It can be said that oil is the foundation of the second industrial revolution and is known as the "blood of industry". Oil not only affects people's daily life and economic development, but also affects the global financial, political and military structures. </h5>
   ...
   <h5>What is your view on the oil price outlook? Regardless of whether you are bullish or bearish, you can easily and conveniently start crude oil trading through <a href="#">us</a>. </br></h5>
   </div>`,
...
<h5>The Australian dollar rose slightly last week due to the rebound in commodity prices such as iron ore and China’s stimulus measures. However, at the moment when the risk sentiment has dropped in an all-round way, the outlook for commodity currencies is still worrying. This week, focus on the support around 0.6720. </h5>`,
  ...
  "m5-i-s1-2-d1":
    "If you're just starting out trading and you're reading everything in the market, you're likely to come across a ton of jargon and terminology. …",
  "m5-i-s1-3-t1": "Technical Analysis",
  "m5-i-s1-3-d1":
    "Technical and price action analysis are two very popular areas of trading research and both involve the use of charts to understand market sentiment, psychology and behavior. However, there are significant differences between the two. …",
  "m5-i-s2-b1": "View All",
  ...
  "m5-wh-i-4-d1":
    "A trend is the direction in which the price of an instrument is moving over a specific period of time. These trends are usually highlighted on a chart by the use of trendlines, which connect two or more price points under a straight line. …",
  ...
  "m5-wh-ta-s2-1-a": `<div class="rich-text__container"><p></p><p><strong>Technical analysis looks at the rhythm, flow and trend of market behavior. </strong>To understand these behaviors, traders can look at a variety of tools to do this, such as analyzing classic chart patterns such as head and shoulders reversal patterns, trading breakouts, or using support and resistance levels. Technical analysis is not just about forecasting, it is also about probability, because in reality, the market is a random series of events. </p><p></p>
    <img  src="" data-sys-asset-uid="bltfa6805d7d782df89" alt="tg-chart-tech-analysis-1.png">
  ...
  "m5-wh-ta-s2-4-a": `<div class="rich-text__container">
    ...
    <h5>EA is not only for executing market orders. They can also be programs such as interesting indicators or systems that show correlations in the market. If you trade on MT4 or MT5, be sure to check out our Smart Trader tools, which are very popular with our clients and can help you take your trading to the next level. Watch our video on <a href="#">Smart Trader Tools</a>,&nbsp;<a href="#">Download our white paper</a> or <a href="/#/contact-us">contact our team</a> to learn more. </h5></div>`,
  ...
  "m5-wh-ti-s4-d1":
    'Smart Trader Tools is a set of 28 expert tools and indicators designed to take your trading abilities to a whole new level. The tool is easy to use, install and access, and is designed for the worlds most popular and powerful trading platforms, such as <a href="/#/trading-platforms/platforms/metatrader4">MetaTrader 4</ a> and <a href="/#/trading-platforms/platforms/metatrader5">MetaTrader 5</a>. </br><a href="/#/trading-platforms/tools/smart-trader-tools">Learn more about Smart Trader tools</a>',
  ...
  "m5-tg-a5-s2-c": `<div class="rich-text__container"><!--StartFragment--><h5>One of the most famous measures of implied volatility is the CBOE The Volatility Index (VIX) of the Institute (CBOE). Now, we have provided customers with transactions of this index on the MT4/5 platform. </h5>
     ...
     <h5>Use the square root of the total trading days in a year: √252=15.9</h5>
     <h5>Daily expected volatility=1.25% (20/15.9=1.25)</h5>
     <h5><u><em>How do I calculate the expected weekly volatility?</em></u></h5>
     <h5>Use the square root of the total number of trading weeks in a year: √50=7.07</h5>
  ...
  This policy describes the types of cookies we use on www.demo.com/cn/ and how we manage them. Your use of our website constitutes your agreement to the terms set forth in this policy.
  </li><li><a href="#">Demo Platform Terms and Conditions</a></li><li><a href="pdf.js/SCB_Risk_Disclosure_Notice_ROW.pdf">
  Risk Disclosure Notice
  </a> –
  This notice contains important information about the risks associated with our products.
  </li><li><a href="pdf.js/SCB_Order_Execution_Policy_ROW.pdf">
  Order Execution Policy
  </a> –
  This policy sets out how we ensure that reasonable steps are taken to achieve the best results for our clients.
  </li><li><a href="pdf.js/SCB_Conflicts_of_Interest_Policy_ROW.pdf">
  ...
  </li><li><a href="pdf.js/SCB_Complaints_Notice_ROW.pdf">
  Complaint Notice
  </a> –
  This notice explains our complaints procedure.
  </li><li><a href="pdf.js/SCB-Website-Terms-ROW.pdf">
  ...
  "ld-s1-d2":
    "If you have any questions about the documentation or need information in another language, please send a request to support{'@'}demo.com and we will make arrangements for you.",
