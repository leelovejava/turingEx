export default {
  taigujiaoyi: "TW Stocks Trade",
  ganggujiaoyi: "HK Stocks Trade",
  Agujiaoyi: "CN Stocks Trade",
  etfjiaoyi: "ETF Trade",
  ...
  yinsibaohu_56:
    "10.1 If you have any requirements and comments, you can send an email to support{'@'}demo.com, this is the only valid official email address we communicate with you, so we do not use effective contact information for you, and we will not be responsible for any actions or failures .",
  yinsibaohu_57:
  ...
  kuangchi_2: "Quant Order generates money and seizes new opportunities",
