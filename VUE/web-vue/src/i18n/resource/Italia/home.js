export default {
  taigujiaoyi: "Commercio di azioni TW",
  ganggujiaoyi: "Commercio di azioni HK",
  Agujiaoyi: "Commercio di azioni CN",
  etfjiaoyi: "Commercio di azioni ETF",
  meigujiaoyi: "commercio di azioni US",
  zhiying: "avere un profitto",
  zhisun: "fermare la perdita",
  zhiyingzhisun: "Prendere profitto Stop Loss",
  etfjiaoyi: "Trading di ETF",
  meigujiaoyi: "commercio di azioni USA",
  niandujingxiaoshang: "Commerciante dell'anno",
  c2c: "C2C",
  licaijijin: "Fondo finanziario",
  kuangchisuocang: "Chiusura piscina",
  wangu: "diecimila azioni",
  wan: "wan",
  nowPrice: "Prezzo attuale",
  baozhengjinbilv: "Rapporto di margine",
  danbibaozhengjinmoshi: "Modalità margine valuta singola",
  weichibaozhengjin: "Margine di mantenimento",
  baozhengjinyue: "Saldo del margine",
  pingduo: "Chiudi a lungo",
  pingkong: "Chiudi corto",
  kaiduo1: "Aperto lungo",
  kaikong1: "Aperto corto",
  zuixinjiage: "Ultimo prezzo",
  yujiyingkui: "Profitti e perdite stimati",
  xianjiakaiduo: "Apri limite lungo",
  xianjiakaikong: "Limite corto aperto",
  shijiakaiduo: "Mercato lungo aperto",
  shijiakaikong: "Aprire il mercato allo scoperto",
  xianjiapingduo: "Chiudi limite lungo",
  xianjiapingkong: "Chiudi limite breve",
  shijiapingduo: "Chiudere il mercato lungo",
  shijiapingkong: "Chiudere il mercato allo scoperto",
  kekaizhangshu: "Può essere aperto",
  kepingzhangshu: "Fogli disponibili",
  zhishujiage: "Prezzo Indice",
  yishixianyingkui: "Profitto realizzato",
  bizhong: "Moneta",
  kepingduo: "I volumi chiudono lacquisto",
  kepingkong: "I volumi chiudono la vendita",
  qingshuruzhangshu: "Si prega di inserire il numero di fogli",

  kaicangbaozhengjin: "Margine per aprire posizioni",
  chengjiaojunjia: "Prezzo della transazione",
  shouyi: "reddito",
  shouyilv: "Tasso di rendimento",
  pingcang: "Chiudi posizione",
  dangqian: "Attuale",
  quancang: "Quancang",
  chicangliang: "Posizione",
  kaicangjunjia: "Prezzo medio di apertura",
  chushibaozhengjin: "Margine iniziale",
  chengjiaojiage: "Prezzo medio di transazione",
  chakanxiangqing: "Visualizza dettagli",
  zanwujilu: "Nessun record",
  yongxudangqianweituodan: "Ordine corrente perpetuo",
  yongxulishiweituodan: "Ordine storico perpetuo",
  yongxudangqianchicang: "Posizione attuale perpetua",
  yongxulishichicangdan: "Ricevuta posizione storica perpetua",
  meiyuan: "prezzo USD",
  zuidi: "prezzo più basso",
  zuigao: "Prezzo più alto",
  liang: "Volume di scambio",
  e: "Fatturato",
  jiaoyishuju: "Dati della transazione",
  jiaoyi: "Transazione",
  shichangxinxi: "Informazioni di mercato",
  dianjizhelixiugaibuju: "Clicca qui per modificare il layout",
  weituodingdan: "Ordine di affidamento",
  shuliang: "Quantità",
  fanhuipankou: "Torna all'handicap",
  tubiao: "carta",
  shichang: "mercato",
  sousuo_bizhongbidui: "Cerca valuta / coppia di valute / contratto",
  zanwushuju: "Ancora nessun dato",
  guanbi: "Chiudi",
  xiangqing: "Dettagli",
  zuishaotou: "Lanci minimi",
  zuidatou: "Numero massimo",
  pingcangchengong: "Chiusura riuscita",
  "24xiaoshizhangdie": "24h alti e bassi",
  chengjiaoe: "Fatturato",
  keyong: "disponibile",
  chaxun: "interrogazione",
  jiaoyidui: "Coppia di scambio",
  zhangdie: "alti e bassi",
  zuixinchengjiao: "Ultima offerta",
  zuixinchengjiao1: "Ultima offerta",
  wodechengjiao: "Il mio affare",
  shijian: "tempo",

  lishichengjiao: "Storia commerciale",
  zichanguanli: "Fondi",
  xitonglianjiewending: "Il collegamento di sistema è stabile",
  announcement: "Notifica annuncio",
  download: "scarica",
  service: "Servizio clienti online",
  ...
  chufatiaojian: "Condizione di attivazione",
  quanche: "Quanche",
  limitOrder: "Limita ordine",
  buy: "acquistare",
  sell: "Vendere",
  txt1: "Non c'è ancora nessun ordine corrente. ",
  chengjiaoshuliang: "Quantità transazione",
  chengjiaojine: "Importo della transazione",
  pingjunjiage: "Prezzo medio",
  wanquanchengjiao: "Transazione completa",
  oneDay: "1 giorno",
  aWeek: "una settimana",
  aMonth: "un mese",
  ...
  currency: "Valuta",
  total: "totale",
  keyongzichan: "Risorse disponibili",
  orderLock: "Blocco ordine",
  valuation: "valutazione",
  text2:
    "Un ordine limite si riferisce all'acquisto o alla vendita a un prezzo specifico o migliore e l'esecuzione di un ordine limite non può essere garantita. ",
  global: "Borsa globale di criptovalute",
  goumaibi:
    "Compra e scambia Bitcoin, Bitcoin Cash, Ethereum, Ripple e più di 300 monete",
  whychoose: "Perché scegliere",
  wendinganquan: "Stabile e sicuro",
  wendinganquanTips:
    "I 10 principali scambi globali per volume di scambi e liquidità. Il nostro sistema di sicurezza sviluppato internamente con più livelli fail-safe fornisce una protezione di livello bancario per le tue criptovalute. ",
  zainishenbian: "al tuo fianco",
  zainishenbianTips:
    "Assistenza clienti professionale 24/7. La conoscenza dà potere a tutti, novizi ed esperti. ",
  qingsonggoumai: "Facile da acquistare criptovaluta",
  qingsonggoumaiTips:
    "Investi nelle tue criptovalute preferite con fiat e goditi le migliori tariffe sul mercato.",
  moreActivities: "ricche attività",
  moreActivitiesTips:
    "Una varietà di taglie interattive e generose ricompense ti stanno aspettando. ",
  guanlitzzh: "Gestisci il tuo portafoglio",
  guanlitzzhTips:
    "Acquista e vendi valute digitali popolari e monitorale tutte in un unico posto. ",
  jingchangebug: "Acquisto ricorrente",
  jingchangebugTips:
    "Investi lentamente nelle criptovalute programmando gli acquisti giornalmente, settimanalmente o mensilmente. ",
  baoxiankubaohu: "Protezione del caveau",
  baoxiankubaohuTips:
    "Per maggiore sicurezza, conserva i tuoi fondi in un caveau e ritarda i prelievi. ",
  zhuoyuejishu: "Tecnologia eccellente",
  zhuoyuejishuTips: "Resta al passo con il mercato con lapp per Android o iOS",
  earnjiamiCoin: "Guadagna fino a $100 in criptovaluta",
  earnjiamiCoinTips:
  ...
  zhangdie: "Modifica",
  type: "Tipo",
  dingdanbu: "Portafoglio ordini",
  jiaoyidui: "Paio",
  chatempty: "Inserisci il contenuto",

  title: "Porta di criptovaluta",
  hangqing: "Mercati",
  yongxuheyue: "Contratti perpetui",
  jiaogeheyue: "Consegna",
  xianhuojiaoyishouye: "Spot",
  denglu: "Accesso",
  zhuce: "Registrati",
  xiazai: "Scarica",
  jiantizhongwen: "Cinese semplificato",
  maibishang: "comprare monete",
  chang1: "La più grande piattaforma di trading di asset blockchain al mondo",
  lijizhuce: "Iscriviti ora",
  shichangqushi: "tendenza di mercato",
  mingcheng: "nome",
  zuixinjia: "Ultimo prezzo",
  "24hzhangdie": "24 ore su e giù",
  "24hjiaoyiliang": "Volume di transazioni 24 ore su 24",
  caozuo: "operare",
  goumai: "Acquistare",
  chang2: "Apri transazioni sempre e ovunque",
  chang3:
    "Compatibile con una varietà di dispositivi per iniziare a fare trading in modo sicuro e conveniente",
  j1: "Gestisci le tue risorse",
  j2: "Fai trading con la leva fino a 100 volte",
  j3: "Pagamento tramite bonifico bancario",
  j4: "Necessità di acquistare criptovaluta con i nostri partner di piattaforma tramite bonifico bancario",
  j5: "deposito sicuro",
  j6: "I fondi dei clienti sono tenuti in portafogli freddi in firme multiple dedicate. Monitoraggio della sicurezza 24 ore su 24, 7 giorni su 7。",
  j7: "Riserva di sicurezza dedicata di 2000BTC",
  j8: "accedere ovunque",
  j9: "Deposita, preleva e fai trading 24 ore su 24, 7 giorni su 7 su app mobili per Android e iOS。",
  j10: "guadagnare soldi ora",
  j11: "Iscriviti ora",
  j12: "iniziare a fare trading",
  j13: "Inizia il tuo viaggio nella valuta digitale",
  j14: "Sviluppo di portafogli blockchain",
  j15: "Archiviazione sicura, conveniente, istantanea, informazioni chiare sulle risorse",
  j16: "Supporta l'archiviazione multi-valuta, importa ed esporta velocemente e gratuitamente",
  j17: "Un clic per aggiungere le risorse richieste Salda le transazioni per visualizzare le risorse in qualsiasi momento",
  j18: "Operazioni di trasferimento rapide, circolazione di fondi flessibile e conveniente",
  j19: "Operazioni di trasferimento rapide, circolazione di fondi flessibile e conveniente",
  j20: "Le risorse crittografate sono valide in modo permanente",
  j21: "Offerta per la scarsità di celebrità crittografiche",
  j22: "Sicurezza dei dati di gioco virtuale",
  j23: "Lo sviluppo degli animali domestici è sicuro e tracciabile",
  j24: "Ecologia aziendale blockchain",
  j25: "Sistema pubblicitario di messaggistica istantanea",
  j26: "Pagare per i contenuti Investire nei social media",
  j27: "Portafoglio elettronico con dati di credito",
  j28: "Applicazione di gioco Blockchain Mall",
  j29: "Compito informatico",
  j30: "Accedi ogni giorno Invita gli amici",
  j31: "Autenticazione facciale Shopping nel centro commerciale",
  j32: "La quantità totale di clic sugli annunci è costante e scarsa",
  j33: "La monetizzazione a valore aggiunto può migliorare la viscosità degli abbonati",
  jiaoyisuo: "scambio",
  dibu1: "chi siamo",
  dibu2: "chi siamo",
  dibu3: "contatto di lavoro",
  dibu4: "Comunità",
  dibu5: "condizioni di servizio",
  dibu6: "Informativa sulla Privacy",
  dibu7: "Centro annunci",
  dibu8: "Notizia",
  dibu9: "Servire",
  dibu10: "Scarica",
  dibu11: "Acquista monete con un clic",
  dibu12: "bonus invito",
  dibu13: "Registro delle modifiche all'account",
  dibu14: "Mandato",
  dibu15: "Transazione contrattuale",
  dibu16: "aiuto",
  dibu17: "centro assistenza",
  dibu18: "Servizio Online",
  dibu19: "Tasso standard",
  dibu20: "Regole commerciali",
  dibu21: "suggerimenti e feedback",
  dibu22: "studia",
  dibu23: "comprare USDT",
  dibu24: "compra bitcoin",
  dibu25: "compra ETH",
  dibu26: "compra SHIB",
  dibu27: "Comunità",
  dibu28: "Cinese semplificato",
  tupianyanzheng: "verifica immagine",
  xiangyouhuadong: "scorri verso destra->",
  tupianyanzhengtongguo: "Verifica dell'immagine superata",
  zhucechenggong: "Registrazione avvenuta",
  yanzhengbutonguo: "Verifica fallita",
  shuaxinchenggong: "Aggiorna con successo",
  home1: "tendenza di mercato",
  home2: "nome",
  home3: "Ultimo prezzo",
  home4: "24 ore su e giù",
  home5: "Volume di transazioni 24 ore su 24",
  home6: "commerciare",
  home7: "Vedi altro",
  home8:
    "La superficie supporta i sistemi IOS, Android, Mac e Windows. Scarica il client e avvia la tua transazione sempre e ovunque。",
  home9: "Guida per principianti",
  home10: "creare un account",
  home11: "Apri la prima transazione con pochi semplici passaggi",
  home12: "depositare",
  home13:
    "Investi il ​​tuo account e inizia il tuo viaggio con più metodi di pagamento supportati。",
  home14: "Verifica completa dell'identità (KYC)",
  home15:
    "Completa la verifica dell'identità (KYC) e diventa un account conforme",
  home16: "iniziare a fare trading",
  home17: "Vendi, acquista o copia operazioni, esplora di più",
  home18: "inizia il tuo viaggio",
  home19: "Inizia il tuo viaggio nella valuta digitale",
  home20: "Sviluppo di portafogli blockchain",
  home21:
    "Archiviazione sicura, conveniente, istantanea, informazioni chiare sulle risorse",
  home22:
    "Supporta l'archiviazione multi-valuta, importa ed esporta velocemente e gratuitamente",
  home23:
    "Aggiungi le risorse richieste con un clic e controlla la transazione del saldo in qualsiasi momento",
  home24:
    "Operazioni di trasferimento rapide, circolazione di fondi flessibile e conveniente",
  home25: "Applicazione di atterraggio Blockchain",
  home26: "Le risorse crittografate sono valide in modo permanente",
  home27: "Offerta per la scarsità di celebrità crittografiche",
  home28: "Sicurezza dei dati di gioco virtuale",
  home29: "Lo sviluppo degli animali domestici è sicuro e tracciabile",
  home30: "Ecologia aziendale blockchain",
  home31: "Sistema pubblicitario di messaggistica istantanea ",
  home32: "Sistema pubblicitario di messaggistica istantanea",
  home33: "Portafoglio elettronico con dati di credito",
  home34: "Applicazione di gioco Blockchain Mall",
  home35: "Compito informatico",
  home36: "Accedi ogni giorno Invita gli amici",
  home37: "Autenticazione facciale Shopping nel centro commerciale",
  home38: "La quantità totale di clic sugli annunci è costante e scarsa",
  home39:
    "La monetizzazione a valore aggiunto può migliorare la viscosità degli abbonati",
  home40: "La piattaforma di trading di criptovalute più affidabile",
  home41:
    "Consente alle persone di scambiare una varietà di risorse digitali su una piattaforma sicura e assicurata",
  home42: "iniziare a usare",
  home43: "Servizio Online",
  historyMsg: "messaggio storico",
  shoujihaobunengweikong: "Il numero di cellulare non può essere vuoto",
  shenfenrenzhenghoujinxinggaojirenzheng:
    "L'autenticazione avanzata può essere eseguita solo dopo l'autenticazione dell'identità",
  weishimingrenzhnegqingxainshimingrenzheng:
    "Nessuna autenticazione con nome reale, per favore prima l'autenticazione con nome reale",
  tui1: "invita gli amici",
  tui2: "guadagnare soldi insieme",
  tui3: "Guadagna fino al 40% di commissione su tutte le negoziazioni in spot, futures e mining pool",
  tui4: "Visualizza le regole di riferimento",
  tui5: "la mia promozione",
  tui6: "Numero totale di promozioni",
  tui7: "Numero di generazioni",
  tui8: "Numero di seconde generazioni",
  tui9: "Tre generazioni",
  tui10: "ID consigliato",
  tui11: "Link di riferimento",
  tui12: "invita gli amici",
  tui13: "Panoramica dei dati",
  tui14: "tutto il tempo",
  tui15: "ieri",
  tui16: "questa settimana",
  tui17: "questo mese",
  tui18: "i tuoi benefici",
  tui19:
    "Commissione guadagnata dai referral che hanno completato transazioni spot, contrattuali o minerarie。",
  tui20: "Numero di utenti di ricarica",
  tui21:
    "Referenti che hanno completato transazioni spot, contrattuali o minerarie",
  tui22: "L'importo totale della ricarica di livello inferiore",
  tui23:
    "Il numero di amici che si sono registrati utilizzando il tuo link di riferimento o codice di riferimento",
  tui24:
    "*L'ora delle statistiche dei dati si basa sull'ora UTC+0 e l'ora di manutenzione dei dati è intorno alle 3-5 (UTC+0) di tutti i giorni Durante questo periodo, il valore del reddito viene calcolato in base alle attività del giorno precedente. Al termine della manutenzione, è possibile visualizzare il normale reddito giornaliero。",
  tui25:
    "*Nota speciale: a causa della complessità dei dati aziendali rilevanti, potrebbero esserci errori di calcolo e ritardi di calcolo.I dati sopra riportati sono solo di riferimento.Ci scusiamo per l'inconveniente.。",
  tui26: "invita gli amici",
  tui27: "Guadagna insieme",
  tui28: "Iscriviti ora e guadagna monete insieme",
  tui29: "ID consigliato",
  tui30: "la mia promozione",
  tui31: "generazione",
  tui32: "seconda generazione",
  tui33: "tre generazioni",
  tui34: "regole di promozione",
  tui35:
    "Lo sviluppo del cliente è il seguente: A | B | C | D | E (fino a 4 livelli in basso), B è il cliente di primo livello di A， ",
  tui36:
    "C è il cliente di secondo livello di A, D è il cliente di terzo livello di A ed E è il cliente di quarto livello di A",
  tui37:
    "(Condizioni di rimborso della commissione: i clienti di basso livello hanno un unico importo di ricarica superiore a 1.000 USDT in un solo giorno e possono riceverlo solo una volta al giorno)",
  tui38: "[commissione A]",
  tui39: "A può ottenere una commissione del 5% dell'importo di ricarica di B",
  tui40: "A può ottenere una commissione del 3% dell'importo di ricarica di C",
  tui41: "A può ottenere una commissione del 2% sull'importo di ricarica di D",
  tui42: "A può ottenere una commissione dell'1% sull'importo di ricarica di E",
  tui43: "[Commissione B]",
  tui44: "'B può ottenere una commissione del 5% dell'importo di ricarica di C",
  tui45: "B può ottenere una commissione del 3% dell'importo di ricarica di D",
  tui46: "B può ottenere una commissione del 2% sull'importo di ricarica di E",
  tui47: "B può ottenere l'1% dell'importo della ricarica E-1",
  tui48: "[Commissione C]",
  tui49: "C può ottenere una commissione del 5% dell'importo di ricarica di D",
  tui50: "C può ottenere una commissione del 3% dell'importo di ricarica di E",
  tui51:
    "C può ottenere una commissione del 2% sull'importo della ricarica E-1",
  tui52: "C può ottenere l'importo della ricarica E-2",
  shouji: "cellulare",
  chexiaodangqianweituo: "Annulla l'ordine corrente",
  weituoleixing: "tipo di commissione",
  shijia: "prezzo di mercato",
  yewuxian: "Linea di affari",
  jiaoyipinzhong: "varietà commerciale",
  quanbu: "Tutto",
  queren: "Confermare",
  chexiaochenggong: "Annullato con successo",
  querendui: "Confermare",
  yongxu: "sostenibile",
  cangweijinxing: "Posizione svolta",
  shijiaquanping: "prezzo di mercato piatto",
  ruguofashengpingcangguadan:
    "Se è presente un ordine in sospeso per la liquidazione (limite di prezzo o ordine stop-loss), verrà annullato prima che sia completamente liquidato。",
  dangqianweituo: "commissione in corso",
  lishiweituo: "commissione storica",
  chengjiaojilu: "Registro delle transazioni",
  dengluhouchakan: "Accedi per visualizzare",
  denglu: "Accesso",
  jiaoyipinzhong: "varietà commerciale",
  weituoshijian: "tempo di commissione",
  jiaoyifangxiang: "Direzione della transazione",
  weituoshuliang2: "Quantità dell'ordine",

  dingdanleixing: "Tipo di ordine",
  dingdanhao: "numero d'ordine",
  dingdanzhaungtai: "Lo stato dell'ordine",
  mairu: "acquistare",
  maichu: "vendere",
  xianjia: "Limite",
  shijia: "prezzo di mercato",
  yitijiao: "presentato",
  yichexiao: "Revocato",
  weituowancheng: "commissione completata",
  xian: "ordine limite",
  shijiaweituo: "ordine di mercato",
  mairujia: "prezzo di acquisto",
  qingshurujiage: "Inserisci un prezzo",
  mairushuliang: "Acquista quantità",
  qingshurushuliang: "Si prega di inserire la quantità",
  keyong: "a disposizione",
  kemairu: "Puoi comprare",
  mairu: "acquistare",
  dengluhoujiaoyi: "Fai trading dopo il login",
  maichujia: "Prezzo di vendita",
  maichushuliang: "quantità di vendita",
  kemai: "disponibile alla vendita",
  kede: "A disposizione",
  maichu: "vendere",
  dengluhoujiaoyi: "Fai trading dopo il login",
  yuebuzuqingchongzhi: "Saldo insufficiente, ricaricare prima",
  caozuochenggong: "Operazione riuscita",
  chiyoucangwei: "ricoprendo posizioni",
  lishicangwei: "Posizioni storiche",
  dengluhouchakan: "Accedi per visualizzare",
  denglu: "Accesso",
  jiaoyipingzhong: "varietà commerciale",
  kaicangshijian: "orario di apertura",
  jiaoyifangxiang: "Direzione della transazione",
  weituoshuliang: "Quantità dell'ordine",
  goumaijia: "prezzo d'acquisto",
  jiesuanjia: "Prezzo di liquidazione",
  yingkui: "profitti e perdite",
  daoqishijian: "Scadenza",
  maiduo: "comprare di più",
  maikong: "vendere allo scoperto",
  zuidijine: "quantità minima",
  keyong: "a disposizione",
  maiduo: "comprare di più",
  dengluhoujiaoyi: "Fai trading dopo il login",
  zuidijine: "quantità minima",
  ...
  maikong: "vendere allo scoperto",
  dengluhoujiaoyi: "Fai trading dopo il login",
  gouamijia: "prezzo d'acquisto",
  fangxiang: "Lato",
  maiduo2: "comprare di più",
  maikong: "vendere allo scoperto",
  shuliang: "Quantità",
  jiaogeshijian: "Consegna",
  jixuxiadan: "continuare a effettuare un ordine",
  qingshurujine: "Inserisci l'importo",
  yuebuzu: "Equilibrio insufficiente",
  yuebuzuqingxianchongzhi: "Saldo insufficiente, ricaricare prima",
  chengjiaomingxi: "Dettagli di Transazione",
  yongxu2: "sostenibile",

  chengjiaoshijian: "tempo di transazione",
  dingdanhao: "numero d'ordine",
  weituozongshuliang: "Quantità totale dell'affidamento",
  yiweituozongshuliang: "Quantità totale affidata",
  jiage: "prezzo",
  weituoshuliangshengyu: "Quantità dell'ordine (rimanente) (pezzi)",
  weituoshuliang: "Quantità affidata (pezzi)",
  zhibiaoshezhi: "Impostazioni indicatore",
  zhishupinghuayidongpingjunxian: "Media mobile livellata esponenzialmente",
  yidongpingjunxian: "media mobile",
  bulinxian: "Bande di Bollinger",
  chengjiaoliang: "Total",
  zhishupinghuayidong: "EMA",
  suijizhibiao: "Stocastico",
  chongzhi: "Ripristina",
  queding: "Sicuro",
  tiaozhengganggan: "regolare la leva",
  gangganbeishu: "Leva",
  dengluhougenggai: "modifica dopo il login",
  quxiao: "Annulla",
  kaicang: "aprire una posizione",
  duishoujia: "Prezzo avversario",
  zhangshu: "Quantità",
  keduokai: "può aprire di più",
  heyuejine: "Ammontare del contratto",
  baozhengjin: "Margine",
  jiancangshouxufei: "Tassa di apertura",
  kekaikong: "Apribile",
  xianjiaweituo: "ordine limite",
  gongxini: "Congratulazioni",
  xiadanchenggong: "ordinato con successo",
  kaiduo: "aperto lungo",
  kaikong: "aperto corto",
  yichengjiao: "Affare fatto",
  weituozongliang: "Totale affidato",
  dingdanguanli: "Lo stato dell'ordine",
  yijianchedan: "Annullamento con un clic",
  chedan: "Cancellazione",
  yichengjiao: "Affare fatto",
  weituozongliang: "Totale affidato",
  dingdanguanli: "Lo stato dell'ordine",
  chakanxiangqing: "controlla i dettagli",

  chushihuabaozhengjin: "margine iniziale",
  biaojijiage: "segnare il prezzo",

  yongxu: "sostenibile",

  zanwujilu: "Nessuna registrazione",
  yongxudangqianweituodan: "Ordine perpetuo corrente",
  yongxulishiweituodan: "Ordine di storia perpetua",
  yongxudangqianchicang: "Posizione attuale perpetua",
  yongxulishichicangdan: "Ricevuta posizione storica perpetua",
  meiyuan: "Prezzo USD",
  zuidi: "Basso",
  ...
  jiage: "prezzo",
  fanhuipankou: "Ritorno al mercato",
  tubiao: "grafico",
  shichang: "mercato",
  sousuo_bizhongbidui: "Cerca valuta / coppia di valute / contratto",
  zanwushuju: "Nessun dato",
  guanbi: "chiusura",
  xiangqing: "particolari",
  zuishaotou: "getto minimo",
  zuidatou: "getto maximo",
  pingcangchengong: "Chiuso con successo",

  language: "Italia",

  yijiangoubi: "Acquisto di monete con un clic",
  jinrongyewu: "Guadagna",
  yongxuheyue_1: "Moneta digitale, transazione professionale",
  jiaogeheyue_1: "Operazione semplice e transazione professionale",
  xianhuojiaoyi_1: "Scambio di gettoni, zero fee, no slip point",
  jijinlicai_1: "Servizio di investimento unico",
  kuangchisuocang_1: "Servire i minatori e migliorare il reddito minerario",
  ...
  yijianmaimai_1:
    "I Big Data ti offrono il business più economico da negoziare",
  ziyoujiaoyi_1:
    "Libera scelta di commercianti soddisfacenti per le transazioni",
  yongxuheyue_1: "Moneta digitale, transazione professionale",
  jiaogeheyue_1: "Operazione semplice e transazione professionale",
  xianhuojiaoyi_1: "Scambio di gettoni, zero fee, no slip point",
  jijinlicai_1: "Servizio di investimento unico",
  ...
  touzizuhe_5: "Acquisto ricorrente",
  touzizuhe_6:
    "Investi lentamente in criptovaluta organizzando acquisti giornalieri, settimanali o mensili.",
  touzizuhe_7: "Protezione della cassaforte",
  touzizuhe_8:
    "Per aumentare la sicurezza, si prega di depositare i fondi nel caveau e ritardare il prelievo.",
  touzizuhe_9: "Eccellenza tecnologica",
  touzizuhe_10:
    "Usa app per Android o iOS per mantenere la leadership di mercato.",

  jiamihuobi_1: "Guadagna criptovaluta del valore fino a $100",
  jiamihuobi_2:
    "Scopri come funziona una particolare criptovaluta e ottieni alcune informazioni su ciascuna criptovaluta per la tua prova.",
  ...
  xnxi_3: "Utente autenticato",

  jiaoyi_1: "Transazione, sempre e ovunque",
  jiaoyi_2: "Scansiona il codice QR",
  jiaoyi_3: "download iOS、Android",

  gongsijianjie: "Profilo aziendale",
  falvyinsizhengce: "Politica legale sulla privacy",

  shiyongtikuan: "Condizioni d'uso",
  fengxianshengming: "Dichiarazione di rischio",
  yinsibaohu: "Tutela della privacy",
  xinshouzhidao: "Orientamento per principianti",
  wenxintishi: "promemoria",
  gouzhiyuzhuanhuan: "Acquisizione e conversione di USDT",
  xiazai: "App",

  fuwu: "servizio",

  jinrongshengtai:
    "Costruire un ecosistema finanziario affidabile in valuta digitale",
  jinrongshengtai_1:
    "Ci impegniamo a rendere più facile e sicuro per gli utenti globali acquistare e vendere valuta digitale. Forniamo vari strumenti, funzioni visive e supporto manuale per consentirti di controllare i fondi in modo più diretto, sicuro e a basso costo.",

  jiaruwomen: "Unisciti a noi",
  jiaruwomen_1:
    "Risolvi i punti di dolore, stabilisci un'esperienza utente eccellente e continua a innovare. Diamo il benvenuto alle persone con una visione comune di unirsi a noi e rendere la valuta digitale più popolare nel mondo.",

  fengxianshengming_0: "Risk statement",
  fengxianshengming_1:
  ...
  kuangchi_2: "Le macchine minerarie generano monete, prendono nuove macchine",
  OnlyDisplayAndPurchase: "Solo DisplayAndPurchase",
  MatchMyAssets: "Abbina le mie risorse",
  ...
  shangchuanfukuanpingzheng: "Carica il buono di pagamento",
  fukuanpingzheng: "Buono di pagamento",
  xianhuolishi: "Spot History",

  zhucejiaoyi: "Registrati e inizia a fare trading!",
  justtwominute: "Inizia a fare trading in soli 2 minuti!",
  emailphonenumber: "Email o numero di telefono",
  singup: "Iscriviti",
