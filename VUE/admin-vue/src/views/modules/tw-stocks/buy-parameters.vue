...
export default {
  data() {
    return {
      ...
      type: "", //type:'forex', //forex->外汇,commodities->大宗商品，指数/ETF->indices, A-stocks->A股, TW-stocks->港股.US-stocks->美股，cryptos->虚拟货币
      menuList: [],
      options: [],
      menuListTreeProps: {
        label: "name",
    ...
    getDataList(page, params, done) {
      ...
      this.$http({
        ...
        params: this.$http.adornParams(
          Object.assign(
            {
              //type:this.type,//type:'forex', //forex->外汇,commodities->大宗商品，指数/ETF->indices, A-stocks->A股, TW-stocks->港股.US-stocks->美股，cryptos->虚拟货币
