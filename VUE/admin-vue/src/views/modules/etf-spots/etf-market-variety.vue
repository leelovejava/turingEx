<template>
  <div class="mod-etf-spots-etf-market-variety">
    <avue-crud
      ref="crud"
      :page.sync="page"
      :data="dataList"
    ...
    >
      <template slot="menuLeft">
        ...
        <el-button 
          ...
          type="primary" size="small" @click.stop="linKinHand(arr)"
          >行情K线设置</el-button
        >
      </template>
...
<script>
import { tableOption } from "@/crud/etf-spots/etf-market-variety";
import AddOrUpdate from "./market-add-or-update";
import mixmarket from "./market-mix-update";
import linKin from "./market-linek";
export default {
  data() {
    return {
      dataForm: {},
