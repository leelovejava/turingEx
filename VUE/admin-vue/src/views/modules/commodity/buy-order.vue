    ...
    >
      ...
      <template slot-scope="scope" slot="menu">
        <el-button
          ...
          icon="el-icon-edit"
          size="small"
          v-if="isAuth('commodity-spots:operate')&&scope.row.state=='submitted'"
...
<script>
import { tableOption } from "@/crud/etf-spots/buy-order";
          ...
          Object.assign(
            {
              ...
              type: "commodities",//forex->外汇,commodities->大宗商品，指数/ETF->indices, A-stocks->A股, HK-stocks->港股.US-stocks->美股，cryptos->数字货币
              offset: "open",
