  ...
  <div class="mod-agents">
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <el-button type="primary"
                   size="small"
                   @click="showConsignmentInfo()">+新增代理商</el-button>
      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            ...
            <el-col :span="3"><span class="item">下级数量</span></el-col>
            <el-col :span="4"><span class="item">UID(推荐码)</span></el-col>
            <el-col :span="4"><span class="item">上级推荐人(ID)</span></el-col>
            <el-col :span="4"><span class="item">用户分享地址</span></el-col>
            <el-col :span="3"><span class="item">备注 </span></el-col>
