  ...
  <div class="mod-transport">
    ...
    >
      ...
      <template slot-scope="scope" slot="TransactionEngineStatus">
        <span v-if="isAuth('india-spots:operate')" class="speacButton" @click="TransactionEngineStatus(scope.row)"
          >查看</span
        >
      </template>
      ...
      <template slot-scope="scope" slot="menu">
        <el-button
          ...
          icon="el-icon-edit"
          size="small"
          v-if="isAuth('india-spots:operate')&&scope.row.state=='submitted'"
