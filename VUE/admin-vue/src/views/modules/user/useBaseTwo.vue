<template>
  <div class="mod-UseBaseTwo">
    <div class="back_Title"><span class="backButton" @click="backButtonTwo"> </span> 用户基础认证</div>
  <el-form :inline="true"
             :model="dataForm"
      ...
      <el-form-item label="账号:">
        <template>
          <el-select v-model="dataForm.value"
                     clearable
                     placeholder="请选择合约">
      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="1"><span class="item product">用户</span></el-col>
            <el-col :span="1"><span class="item">UID</span></el-col>
            <el-col :span="2"><span class="item">推荐人</span></el-col>
            <el-col :span="1"><span class="item">账户类型</span></el-col>
            <el-col :span="1"><span class="item">实名姓名</span></el-col>
            <el-col :span="2"><span class="item">绑定手机 </span></el-col>
            <el-col :span="2"><span class="item">绑定邮箱</span></el-col>
            <el-col :span="4"><span class="item">认证状态</span></el-col>
            <el-col :span="4"><span class="item">客户提交时间</span></el-col>
            <el-col :span="3"><span class="item">审核操作时间</span></el-col>
            <el-col :span="1"><span class="item">原因</span></el-col>
            <el-col :span="2"><span class="item"></span></el-col>
          </el-row>
        </div>
        <div class="prod"
...
export default {
  ...
  props:['useBaseButtonTwo'],
    // 
  
  methods: {
    backButtonTwo(){
      this.$emit('useBaseButtonTwo',false)
    },
    // 获取数据列表
