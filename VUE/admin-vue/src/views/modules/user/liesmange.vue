  ...
  <div class="mod-liesmange">
    ...
    <div class="main">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="查询结果" name="1"></el-tab-pane>
      </el-tabs>
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="6"><span class="item product">产品交易对</span></el-col>
            <el-col :span="6"><span class="item">原值</span></el-col>
            <el-col :span="6"><span class="item">调整后</span></el-col>
            <el-col :span="6"><span class="item"></span></el-col>
          </el-row>
        </div>
        <div class="prod"
