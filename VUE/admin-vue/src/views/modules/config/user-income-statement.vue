  ...
  <el-form :inline="true"
    ...
    <div class="main">
      <el-tabs v-if="activeName=='2'" v-model="activeName2" @tab-click="handleClick2">
        ...
        <el-tab-pane label="已持仓" name="3"></el-tab-pane>
      </el-tabs>
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            ...
            <el-col :span="1"><span class="item">品种</span></el-col>
            <el-col :span="1"><span class="item">操作</span></el-col>
            <el-col :span="2"><span class="item">成交均价 </span></el-col>
            <el-col :span="2"><span class="item">止盈止损</span></el-col>
            <el-col :span="4"><span class="item">剩余委托金额</span></el-col>
            <el-col :span="4"><span class="item">剩余委托保证金</span></el-col>
            <el-col :span="1"><span class="item">余额</span></el-col>
            <el-col :span="1"><span class="item">盈亏</span></el-col>
            <el-col :span="1"><span class="item">状态</span></el-col>
            <el-col :span="1"><span class="item">状态</span></el-col>
            <el-col :span="2"><span class="item">平仓时间</span></el-col>
          </el-row>
        </div>
        <div class="prod"
