  ...
  <div class="mod-transport">
    ...
    >
      <template slot="menuLeft">
        <el-button
          v-if="isAuth('config:suspension:operate')"
          type="primary"
          icon="el-icon-plus"
          size="small"
...
<script>
import { tableOption } from "@/crud/config/suspension";
import AddOrUpdate from "./suspension-add-or-update";
export default {
  data() {
    return {
      dataList: [],
  ...
  methods: {
    ...
    getDataList(page, done) {
      ...
      this.$http({
        url: this.$http.adornUrl("/syspara/openClose/list"),
        method: "get",
