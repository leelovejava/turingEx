      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="3"><span class="item product">币种名称</span></el-col>
            <el-col :span="3"><span class="item">代码</span></el-col>
            <el-col :span="3"><span class="item">交易对</span></el-col>
            <el-col :span="3"><span class="item">每张金融</span></el-col>
            <el-col :span="3"><span class="item">每张手续费</span></el-col>
            <el-col :span="3"><span class="item">最小变动单位</span></el-col>
            <el-col :span="3"><span class="item">最小变动单位的盈亏金额</span></el-col>
