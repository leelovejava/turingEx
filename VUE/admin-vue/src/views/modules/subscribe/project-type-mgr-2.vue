      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="1"><span class="item product">项目ID</span></el-col>
            <el-col :span="2"><span class="item">项目种类</span></el-col>
            <el-col :span="2"><span class="item">香港股票</span></el-col>
            <el-col :span="2"><span class="item">香港股票品种</span></el-col>
            <el-col :span="2"><span class="item">申购品种</span></el-col>
            <el-col :span="2"><span class="item">数据源类别</span></el-col>
            <el-col :span="1"><span class="item">代码</span></el-col>
            <el-col :span="1.5"><span class="item">交易对象</span></el-col>
            <el-col :span="1.5"><span class="item">每张金额</span></el-col>
            <el-col :span="2"><span class="item">每张手续费</span></el-col>
            <el-col :span="2"><span class="item">最小变动单位</span></el-col>
            <el-col :span="4"><span class="item">最小变动单位的盈亏金额</span></el-col>
