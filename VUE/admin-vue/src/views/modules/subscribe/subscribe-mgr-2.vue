  ...
  <el-form :inline="true"
    ...
    <div class="main">
      <el-tabs v-if="activeName=='2'" v-model="activeName2" @tab-click="handleClick2">
        ...
        <el-tab-pane label="申购中" name="2"></el-tab-pane>
        <el-tab-pane label="已结束" name="3"></el-tab-pane>
      </el-tabs>
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="1"><span class="item product">ID</span></el-col>
            <el-col :span="1"><span class="item">项目总类</span></el-col>
            <el-col :span="1"><span class="item">相关股票</span></el-col>
            <el-col :span="2"><span class="item">申购项目名称</span></el-col>
            <el-col :span="1"><span class="item">数据源类别</span></el-col>
            <el-col :span="1"><span class="item">发行价</span></el-col>
            <el-col :span="2"><span class="item">接受申购的币种</span></el-col>
            <el-col :span="2"><span class="item">预计上线时间</span></el-col>
            <el-col :span="2"><span class="item">开始申购时间</span></el-col>
            <el-col :span="2"><span class="item">结束申购时间</span></el-col>
            <el-col :span="2"><span class="item">公布结果时间</span></el-col>
            <el-col :span="2"><span class="item">最小申购数量</span></el-col>
            <el-col :span="2"><span class="item">最大申购数量</span></el-col>
            <el-col :span="2"><span class="item">白皮书地址</span></el-col>
            <el-col :span="1"><span class="item">操作</span></el-col>
          </el-row>
        </div>
        <div class="prod"
