    ...
    <div class="main">
        ...
        <div class="tit">
          <el-row style="width:100%">
            ...
            <el-col :span="1"><span class="item">活动名称</span></el-col>
            <el-col :span="1"><span class="item">活动图片</span></el-col>
            <el-col :span="2"><span class="item">上架/下架</span></el-col>
            <el-col :span="1"><span class="item">活动状态</span></el-col>
            <el-col :span="2"><span class="item">一级邀请</span></el-col>
            <el-col :span="2"><span class="item">活动类型</span></el-col>
            <el-col :span="2"><span class="item">币种数量/价格</span></el-col>
            <el-col :span="2"><span class="item">开始时间</span></el-col>
            <el-col :span="2"><span class="item">结束时间</span></el-col>
            <el-col :span="2"><span class="item">公告链接</span></el-col>
            <el-col :span="2"><span class="item">活动链接</span></el-col>
            <el-col :span="1"><span class="item">进度</span></el-col>
            <el-col :span="2"><span class="item">创建时间</span></el-col>
            <el-col :span="1"><span class="item"></span></el-col>
          </el-row>
        </div>
        <div class="prod"
