      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="2"><span class="item product">项目ID</span></el-col>
            <el-col :span="2"><span class="item">UID</span></el-col>
            <el-col :span="2"><span class="item">用户名</span></el-col>
            <el-col :span="4"><span class="item">认购付款币种数量</span></el-col>
            <el-col :span="2"><span class="item">支付币种</span></el-col>
            <el-col :span="2"><span class="item">申购时间</span></el-col>
            <el-col :span="3"><span class="item">所属项目种类</span></el-col>
            <el-col :span="3"><span class="item">申购项目名称</span></el-col>
            <el-col :span="4"><span class="item">申购项目币种数量</span></el-col>
          </el-row>
        </div>
        <div class="prod"
