  ...
  <div class="mod-bank_pay_mgr">
    ...
    >
      ...
      <template slot-scope="scope" slot="moreNp">
        <span class="speacButton"  v-if="isAuth('order:paymgr:message')" @click="moreNp(scope.row)">点击查看</span>
      </template>
      <template slot-scope="scope" slot="menu">
        ...
        <el-button
          ...
          icon="el-icon-delete"
          size="small"
          v-if="isAuth('order:paymgr:delete')"
