<template>
  ...
  >
    <el-form
      ...
      label-width="90px"
    >
    <el-form-item label="国家/地区" prop="" v-if="dataForm.nationality">
        <el-input v-model="dataForm.nationality" disabled placeholder="国家/地区">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="付款凭证" prop="">
        <img :src="dataForm.img" alt="" width="200">
      </el-form-item>
