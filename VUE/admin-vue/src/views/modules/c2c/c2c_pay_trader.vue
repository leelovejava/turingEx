      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="1"><span class="item product">用户名</span></el-col>
            <el-col :span="1"><span class="item">UID</span></el-col>
            <el-col :span="2"><span class="item">用户数</span></el-col>
            <el-col :span="2"><span class="item">代理数</span></el-col>
            <el-col :span="2"><span class="item">充值USDT</span></el-col>
              ...
              <el-col :span="3"
                ...
                <div class="item">
                  <div class="operate">
                    ...
                    <el-button v-if="isAuth('c2c:c2c-pay-trader:search')"
                               type="text"
                               size="small"
