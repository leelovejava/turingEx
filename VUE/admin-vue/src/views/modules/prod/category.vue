  ...
  <div class="mod-category">
    <el-form :inline="true"
      ...
      <el-form-item label="矿机:">
        <template>
          <el-select v-model="dataForm.status2"
                     clearable
                     placeholder="请选择">
      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            ...
            <el-col :span="2"><span class="item">产品名称</span></el-col>
            <el-col :span="2"><span class="item">产品名称(英文)</span></el-col>
            <el-col :span="1"><span class="item">金额 </span></el-col>
            <el-col :span="2"><span class="item">收益</span></el-col>
            <el-col :span="2"><span class="item">买入时间</span></el-col>
            <el-col :span="2"><span class="item">开始时间</span></el-col>
            <el-col :span="2"><span class="item">停止时间</span></el-col>
            <el-col :span="2"><span class="item">赎回时间</span></el-col>
