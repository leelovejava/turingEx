<template>
  ...
  <el-form :inline="true"
      ...
      <el-form-item label="账号">
        <el-select v-model="region" placeholder="所有账号">
      ...
      <el-form-item label="类型">
        <el-select v-model="region" placeholder="所有类型">
          <el-option label="区域一" value="shanghai"></el-option>
          <el-option label="区域二" value="beijing"></el-option>
        </el-select>
      </el-form-item>
      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="3"><span class="item product">用户名</span></el-col>
            <el-col :span="2"><span class="item">UID</span></el-col>
            <el-col :span="3"><span class="item">推荐人</span></el-col>
            <el-col :span="2"><span class="item">账户类型</span></el-col>
            <el-col :span="2"><span class="item">ETH</span></el-col>
            <el-col :span="2"><span class="item">USDT</span></el-col>
            <el-col :span="3"><span class="item">日志类型</span></el-col>
            <el-col :span="3"><span class="item">关联订单</span></el-col>
            <el-col :span="2"><span class="item">状态</span></el-col>
            <el-col :span="2"><span class="item">时间</span></el-col>
            <!-- <el-col :span="2"><span class="item">交易盈亏</span></el-col>
            <el-col :span="2"><span class="item">手续费</span></el-col>
            <el-col :span="2"><span class="item">总收益</span></el-col> -->
          </el-row>
        </div>
        <div class="prod"
