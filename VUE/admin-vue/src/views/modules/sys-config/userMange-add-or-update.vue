<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="资金密码" prop="safePassword"  class="is-required" >
        <el-input v-model="dataForm.safePassword" type="password" placeholder="资金密码"></el-input>
      </el-form-item>
...
<script>
  ...
  export default {
    data () {
      ...
      var validatesafePassword = (rule, value, callback) => {
        if (!this.dataForm.id && !/\S/.test(value)) {
      ...
      return {
        ...
        dataRule: {
          ...
          { validator: validatesafePassword, trigger: 'blur' }
          ],
          email: [
