export default {
    ...
    WithdrawalTitle1: "Currently, withdrawal only supports digital currency.",
    ...
    '智能矿池': 'Smart pool',
    '真实矿机租赁，套餐选择灵活': 'Real Quant Order rental, flexible package options',
    ...
    'KD5矿机': 'KD5 Quant Order',
    'CK5矿机': 'CK5 Quant Order',
    'HS5矿机': 'HS5 Quant Order',
    'LT5 PRO矿机': 'LT5 PRO miner',
    'M30s+122T矿机': 'M30s+122T Quant Order',
    ...
    '3、矿机购买满24小时之后每日凌晨4点收益将直接发放至账户，可进行交易等操作。去挖矿': '3. After the Quant Order is purchased for 24 hours, the profit will be directly distributed to the account at 4:00 am every day, and operations such as transactions can be performed. to mine',
    '去挖矿': 'To mine',
    ...
    '值得信赖的矿机共享平台': 'Reliable Quant Order sharing platform.',
    ...
    "矿机名称": "Miner name",
    "矿机金额": "Miner amount",
    "矿机类型介绍": "Introduction to Quant Order types",
...
"loanRuleContent4":"Yes, you can withdraw the borrowed assets. However, please note that your repayments cannot be deducted from your Helix Capital account. You need to complete the repayment before you can perform the withdrawal function.",
"loanRuleTitle4":"4. Can the borrowed assets be withdrawn?",
"loanRuleContent3":"The borrowed tokens can be used for any trading activities on Helix Capital (leveraged trading, contract trading).",
"loanRuleTitle3":"3. What products can the borrowed assets be traded on Helix Capital?",
"loanRuleContent2":"The loan process is as simple as possible. All you need is a Helix Capital account. Ensure that you have sufficient collateral assets in your Helix Capital account to apply for the loan, agree to the terms, and then contact customer support for confirmation.",
"loanRuleTitle2":"2. How can I get a loan? What are the requirements?",
"loanRuleContent1":"Helix Capital Loan is a financial service offered in partnership with a third-party lending company, providing you with loans to meet short-term liquidity funding needs.",
"loanRuleTitle1":"1. What is Helix Capital Loan?",
   '外汇合约':'Foreign Delivery',
    ...
    '公布中签,上市': "Notice of winning lottery and listing",
    ...
    aiQuantQuantifiableDays: 'Running Days',
    ...
    aiQuantEarningsRedeemToast: 'Redeem successful',
    aiQuantEarningsTrialNoRedeem: 'AI trial products do not support early redemption',
