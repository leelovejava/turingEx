    ...
    <div class="container-box">
      ...
      <section class="tab-container">
        <section class="etf-container">
          ...
          <div class="nav">
            <de-stock-ex-nav :prominentListData="prominentListData" />
          </div>
          ...
          <div class="all-etf-ranking">
            ...
            <div class="more-box" v-if="prominentListData.length > 5" @click="moreOpen(0, t('WellUSstocks'))">
...
import deStockExNav from "@/components/trade/de-stock-ex-nav/index.vue";
