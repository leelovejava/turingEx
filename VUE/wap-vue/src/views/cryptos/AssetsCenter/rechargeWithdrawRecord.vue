<template>
    <div class="rechargeWithdrawRecord">
        ...
        <div>
            <div class="flex justify-around mb-33 border-b-color mt-12 text-34">
                <div class="width-44 text-grey flex flex-col items-center" @click="tabClick('1')"
                    :class="type == '1' ? 'active-line' : ''">{{ $t('充值') }}</div>
                <div class="ml-24 text-grey width-170 flex flex-col items-center" @click="tabClick('2')"
