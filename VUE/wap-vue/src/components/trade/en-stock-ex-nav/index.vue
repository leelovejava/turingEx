      ...
      this.navList = [
        {
          ...
          path: `/quotes/openTrade?tabActive=0&symbol=${val[0].symbol}&type=UK-stocks`
        },
        {
          name: this.$t('永续合约'),
          ...
          path: `/cryptos/perpetualContract/${val[0].symbol}?type=UK-stocks&selectIndex=1`
        },
        {
          name: this.$t('交割合约'),
          ...
          path: `/cryptos/perpetualContract/${val[0].symbol}?type=UK-stocks&selectIndex=2`
        },
        {
          name: this.$t('账变记录'),
          ...
          path: '/cryptos/accountChange?type=UK-stocks'
        },
      ]
    }
  },
