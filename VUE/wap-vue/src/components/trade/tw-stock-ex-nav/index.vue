      ...
      this.navList = [
        {
          ...
          path: `/quotes/openTrade?tabActive=0&symbol=${symbol}&type=TW-stocks`
        },
        {
          name: this.$t('永续合约'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/twNav/icon02.png`, import.meta.url),
          path: `/cryptos/perpetualContract/${symbol}?type=TW-stocks&selectIndex=1`
        },
        {
          name: this.$t('交割合约'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/twNav/icon03.png`, import.meta.url),
          path: `/cryptos/perpetualContract/${symbol}?type=TW-stocks&selectIndex=2`
        },
        {
          name: this.$t('账变记录'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/twNav/icon04.png`, import.meta.url),
          path: '/cryptos/accountChange?type=TW-stocks'
        },
      ]
    }
  },
      ...
      navList: [
        {
          name: this.$t('台股交易'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/twNav/icon01.png`, import.meta.url),
          path: '/quotes/openTrade?tabActive=0&symbol=AAPL&type=TW-stocks'
        },
        {
          name: this.$t('永续合约'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/twNav/icon02.png`, import.meta.url),
