      ...
      this.navList = [
        {
          ...
          path: `/quotes/openTrade?tabActive=0&symbol=${val[0].symbol}&type=DE-stocks`
        },
        {
          name: this.$t('永续合约'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/etfNav/icon2-2.png`, import.meta.url),
          path: `/cryptos/perpetualContract/${val[0].symbol}?type=DE-stocks&selectIndex=1`
        },
        {
          name: this.$t('交割合约'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/etfNav/icon3-3.png`, import.meta.url),
          path: `/cryptos/perpetualContract/${val[0].symbol}?type=DE-stocks&selectIndex=2`
        },
        {
          name: this.$t('账变记录'),
          icon: new URL(`../../../assets/theme/${thStore.theme}/image/etfNav/icon4-4.png`, import.meta.url),
          path: '/cryptos/accountChange?type=DE-stocks'
        },
      ]
    }
  },
