...
public class C2cPaymentMethodServiceImpl extends ServiceImpl<C2cPaymentMethodMapper, C2cPaymentMethod>  implements C2cPaymentMethodService {
    ...
    public Map<String, C2cPaymentMethod> getByC2CPartyId(String partyId) {
        return getByPartyIdAndType(partyId,"2");
    }

    public Map<String, C2cPaymentMethod> getByPartyIdAndType(String partyId, String type) {
        List<C2cPaymentMethod> c2cPaymentMethodList=  list(Wrappers.<C2cPaymentMethod>query().lambda()
                .eq(C2cPaymentMethod::getPartyId, partyId)
                .eq(C2cPaymentMethod::getType, type));
    ...
    public Map<String, C2cPaymentMethod> getByBankCardPartyId(String partyId) {
        return getByPartyIdAndType(partyId,"1");
    }
