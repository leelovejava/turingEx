...
public class C2cAppealServiceImpl extends ServiceImpl<C2cAppealMapper, C2cAppeal> implements C2cAppealService {
    ...
    @Override
    public Page pagedQuery(Page page, String status, String orderNo, String userCode, String roleName, String c2cUserCode, String c2cUserType, String c2cUserPartyCode , List<String> children) {
        return baseMapper.pagedQuery(page,status,orderNo,userCode,roleName,c2cUserCode,c2cUserType,c2cUserPartyCode,children);
    }
