...
public interface C2cOrderMapper  extends BaseMapper<C2cOrder> {
    ...
    Page pagedQuery(Page page, @Param("direction")  List<String> direction, @Param("state") String state,
               @Param("party_id") String party_id);


    Page pagedQueryC2c(Page page,@Param("direction")  List<String> direction, @Param("state") String state,
                       @Param("loginpartyid") String loginpartyid,@Param("c2cuser") boolean c2cuser);
