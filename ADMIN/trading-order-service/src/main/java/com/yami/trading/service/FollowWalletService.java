...
public interface FollowWalletService extends IService<FollowWallet> {
    FollowWallet findByUserId(String userId);
    ...
    FollowWalletExtend saveExtendByPara(String userId, String wallettype);
