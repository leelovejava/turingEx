...
public interface C2cAppealService  extends IService<C2cAppeal> {
    ...
    Page pagedQuery(Page page, String status, String orderNo, String userCode, String roleName, String c2cUserCode, String c2cUserType, String c2cUserPartyCode , List<String> children);
