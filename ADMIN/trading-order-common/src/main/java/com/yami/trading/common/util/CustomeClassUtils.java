 ...
 */
@UtilityClass
public class CustomeClassUtils extends org.springframework.util.ClassUtils {
	private final static Logger logger = LoggerFactory.getLogger(CustomeClassUtils.class);
	...
	public <A extends Annotation> A getAnnotation(Method method, Class<A> annotationType) {
		...
		Method specificMethod = CustomeClassUtils.getMostSpecificMethod(method, targetClass);
