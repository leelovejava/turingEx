...
//	public final static String CMS_LANGUAGE_CONTENTCODE = "CMS_LANGUAGE_CONTENTCODE_";
	...
	public final static String C2C_TRANSLATE_CONTENT_LANGUAGE = "C2C_TRANSLATE_CONTENT_LANGUAGE:";
	...
	public final static String SYMBOL_VOLUME = "SYMBOL_VOLUME_";

	// 刚刚创建，并且尚未由 ContractApplyOrder 记录产生 ContractOrder 记录的缓存
	public static final String NEW_CONTRACT_APPLY_ORDERS = "new_contract_apply_orders";

	//
	public static final String TIPLIST = "TIPLIST_";

	// realTime 缓存前缀，后缀： {symbol}
	// realTime 的关键元素组合: {symbol} + ":" + {id}
	public static final String SORTED_REALTIME_INFO = "sorted_realtime_info_";
	// realTime 缓存完整信息，后缀： {symbol}，field: id，value: {json}
	public static final String MAP_REALTIME_DATA = "map_realtime_data_";

	// kline 缓存前缀，后缀: {symbol}:{line}
	// kline 的关键元素组合: {symbol} + ":" + {line} + ":" + {id}
	public static final String SORTED_KLINE_INFO = "sorted_kline_info_";
	// kline 缓存前缀，后缀: {symbol}:{line}
	public static final String MAP_KLINE_DATA = "map_kline_data_";

	// 风控配置信息, field: {type}:{clientType}:{clientKey},  value: {风控对象}
	public static final String MAP_RISK_CLIENT_DATA = "map_risk_client";

	// 一个大集合对象一次性存入 redis
	public static final String RISK_CLIENT_DATA = "risk_client_data";
