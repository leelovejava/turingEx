...
public class ContractOrderDTO  {
	...
	public String getVolumeUnitAmount() {
		...
		BigDecimal bigDecimal1 = volume.multiply(unitAmount).setScale(2, RoundingMode.FLOOR);
	...
	public String getVolumeOpenUnitAmount() {
		...
		BigDecimal bigDecimal2 = volumeOpen.multiply(unitAmount).setScale(2, RoundingMode.FLOOR);
	...
	public String getDd() {
		...
		return deposit.setScale(2, RoundingMode.FLOOR).toPlainString()+"/"+depositOpen.setScale(2, RoundingMode.FLOOR).toPlainString();
	}
}
