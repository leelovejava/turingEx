...
public class ItemSummary extends UUIDEntity {
     ...
     * 证券类型
     */
    @ApiModelProperty("证券类型/基金类型/過戶機構")
     ...
     * 电话号码
     */
    @ApiModelProperty("电话号码，公司電話")
    private String orgTel;

    /**
     * 传真号码
     */
    @ApiModelProperty("传真号码,過戶電話")
...
//    private String navPerShare;
    ...
    private String netUnitValue;

    /**
     *净值增长率
     */
    @ApiModelProperty("净值增长率")
    private String netWorthGrowthRate;
     ...
     *最新规模
     */
    @ApiModelProperty("最新规模")
    private String latestScale;

    /**
     *申购状态
     */
    @ApiModelProperty("申购状态")
    private String subscriptionStatus;

    /**
     *赎回状态
     */
    @ApiModelProperty("赎回状态")
    private String redemptionStatus;

    /**
     *收益分配原则
     */
    @ApiModelProperty("收益分配原则")
    private String incomeDistributionPrinciple;
