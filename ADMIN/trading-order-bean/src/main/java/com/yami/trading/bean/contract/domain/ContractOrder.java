...
public class ContractOrder extends BaseEntity {
    ...
    public BigDecimal getChangeRatio() {
        ...
        changeRatio = profit.divide(depositOpen,10 , RoundingMode.HALF_UP);
        changeRatio = changeRatio.multiply(new BigDecimal("100")).setScale(4, BigDecimal.ROUND_HALF_DOWN);
        return changeRatio;
    }
