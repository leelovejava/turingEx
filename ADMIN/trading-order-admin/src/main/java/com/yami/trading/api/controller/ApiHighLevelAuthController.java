...
public class ApiHighLevelAuthController {
    ...
    public Result applyHighLevelAuth(ApplyHighLevelAuthModel model) {
...
//        }
        ...
        if (Constants.SECURITY_ROLE_MEMBER.equals(user.getRoleName())) {
            tipService.saveTip(highLevelAuthRecord.getUuid(), TipConstants.KYC_HIGH_LEVEL,user.getUserId());
        }
