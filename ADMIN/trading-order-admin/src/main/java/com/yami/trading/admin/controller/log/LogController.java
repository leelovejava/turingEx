...
public class LogController {
    ...
    public Result<Page<LogDto>> list(@RequestBody @Valid LogListModel model){
        ...
        logService.listPage(page,model.getRoleName(),model.getUserName(),
                model.getLog(),model.getCategory(), model.getOperator(),
                permissionFacade.getOwnerUserIds(), !SecurityUtils.getSysUser().getUsername().equals("root"));
