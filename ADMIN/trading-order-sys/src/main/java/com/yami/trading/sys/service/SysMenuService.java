...
public interface SysMenuService extends IService<SysMenu> {
	 ...
	 * @return 菜单列表
	 */
	List<SysMenu> listMenuByUserId(Long userId,String appType);
	 ...
	 * @return 角色所拥有的菜单id列表
	 */
	List<Long> listMenuIdByRoleId(Long roleId,String appType);

	/**
	 * 获取简单的menu tree 用于在ele-ui tree中显示，根据orderNum排序
	 * @return 所有的菜单
	 */
	List<SysMenu> listSimpleMenuNoButton(String appType);
	...
	List<SysMenu> listMenuAndBtn(String appType);
}
